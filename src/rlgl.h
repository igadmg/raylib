...
RLAPI void rlSetBlendColor(unsigned char r, unsigned char g, unsigned char b, unsigned char a);
...
RLAPI void *rlReadTexturePixelsMemory(unsigned int id, int width, int height, int format, void * memory); // Read texture pixel data to preallocated memory
...
// Set blending mode factor and equation separately for RGB and alpha
void rlSetBlendColor(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
{
    // Color values clamp to 0.0f(0) and 1.0f(255)
    float cr = (float)r/255;
    float cg = (float)g/255;
...
// Read texture pixel data to preallocated memory
void *rlReadTexturePixelsMemory(unsigned int id, int width, int height, int format, void *pixels)
{
#if defined(GRAPHICS_API_OPENGL_11) || defined(GRAPHICS_API_OPENGL_33)
    glBindTexture(GL_TEXTURE_2D, id);
